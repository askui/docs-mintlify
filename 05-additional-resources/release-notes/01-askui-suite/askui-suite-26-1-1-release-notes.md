...
| OS | Arch | Link|
| --- | ----| ---|
| Windows | AMD64 | [Link](https://files.askui.com/releases/Installer/26.1.1/AskUI-Suite-26.1.1-User-Installer-Win-AMD64-Web.exe)
| Windows | ARM64 | [Link](https://files.askui.com/releases/Installer/26.1.1/AskUI-Suite-26.1.1-User-Installer-Win-ARM64-Web.exe)
| MacOS | ARM64 | [Link](https://files.askui.com/releases/Installer/26.1.1/AskUI-Suite-26.1.1-User-Installer-MacOS-ARM64-Web.run)
| Linux | AMD64 | [Link](https://files.askui.com/releases/Installer/26.1.1/AskUI-Suite-26.1.1-User-Installer-Linux-AMD64-Web.run)
| Linux | ARM64 | [Link](https://files.askui.com/releases/Installer/26.1.1/AskUI-Suite-26.1.1-User-Installer-Linux-ARM64-Web.run)
...
- Rename `Set-AsGloablInstallation` to `Set-AsSystemInstallation`


## New Features

- **AgentOS**
  - `Add-AskUIAgentOSService` installs the AgentOS as a Windows Service to control the Login Screen
  - `Remove-AskUIAgentOSService` remvoes the AgentOS as a Service
...
| AskUIRemoteDeviceController            | 0.25.0.0  | [Link](https://github.com/askui/askui-ui-controller/releases/tag/26.1.1) |
| AskUIRemoteDeviceSnippingTool       | 0.3.0.0   | [Link](https://github.com/askui/askui-ui-controller/releases/tag/26.1.1) |
| UIController                                         | 0.17.0  | [Link](https://github.com/askui/askui-ui-controller/releases/tag/26.1.1) |
