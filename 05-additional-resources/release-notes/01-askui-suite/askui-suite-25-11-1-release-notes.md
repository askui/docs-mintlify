...
| OS | Arch | Link|
| --- | ----| ---|
| Windows | AMD64 | [Link](https://files.askui.com/releases/Installer/25.11.1/AskUI-Suite-25.11.1-User-Installer-Win-AMD64-Web.exe)
| Windows | ARM64 | [Link](https://files.askui.com/releases/Installer/25.11.1/AskUI-Suite-25.11.1-User-Installer-Win-ARM64-Web.exe)
| MacOS | ARM64 | [Link](https://files.askui.com/releases/Installer/25.11.1/AskUI-Suite-25.11.1-User-Installer-MacOS-ARM64-Web.run)
| Linux | AMD64 | [Link](https://files.askui.com/releases/Installer/25.11.1/AskUI-Suite-25.11.1-User-Installer-Linux-AMD64-Web.run)
| Linux | ARM64 | [Link](https://files.askui.com/releases/Installer/25.11.1/AskUI-Suite-25.11.1-User-Installer-Linux-ARM64-Web.run)
...
- Removed the dependency on cmd.exe for directory creation on Windows.
- Removed empty credential environment variables when not set.
  

## New Features

- Added an auto-recovery service for the Remote Device Controller binary used by Python library users.
...
| AskUIRemoteDeviceController            | 0.22.0.1  | [Link](https://github.com/askui/askui-ui-controller/releases/tag/25.11.1) |
| AskUIRemoteDeviceSnippingTool       | 0.2.1   | [Link](https://github.com/askui/askui-ui-controller/releases/tag/25.11.1) |
| UIController                                         | 0.17.0  | [Link](https://github.com/askui/askui-ui-controller/releases/tag/25.11.1) |
| AskUIRemoteDeviceSetupTool          | 0.3.1  | [Link](https://github.com/askui/askui-ui-controller/releases/tag/25.11.1) |
