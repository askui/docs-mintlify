...
| OS | Arch | Link|
| --- | ----| ---|
| Windows | AMD64 | [Link](https://files.askui.com/releases/Installer/25.8.2/AskUI-Suite-25.8.2-User-Installer-Win-AMD64-Web.exe)
| Windows | ARM64 | [Link](https://files.askui.com/releases/Installer/25.8.2/AskUI-Suite-25.8.2-User-Installer-Win-ARM64-Web.exe)
| MacOS | ARM64 | [Link](https://files.askui.com/releases/Installer/25.8.2/AskUI-Suite-25.8.2-User-Installer-MacOS-ARM64-Web.run)
| Linux | AMD64 | [Link](https://files.askui.com/releases/Installer/25.8.2/AskUI-Suite-25.8.2-User-Installer-Linux-AMD64-Web.run)
| Linux | ARM64 | [Link](https://files.askui.com/releases/Installer/25.8.2/AskUI-Suite-25.8.2-User-Installer-Linux-ARM64-Web.run)
...
3. Enter `pip install askui==0.12.0`
...
- Add Mesa software driver fallback if OpenGL is missing.
