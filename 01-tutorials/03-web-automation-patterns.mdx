...
<Tip>
Visual relationships ([`above_of`](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#above-of), [`below_of`](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#below-of), [`left_of`](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#left-of), [`right_of`](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#right-of)) are powerful for targeting elements in dynamic layouts.
</Tip>
