...
<Steps>
  <Step title="Create an AskUI Account">
    Sign up at [app.caesr.ai](https://app.caesr.ai) to:
  ...
  <Step title="Set Up Authentication">
    Configure your environment variables with your credentials ([Create Access Token](https://app.caesr.ai/)):
    ...
    <Tip>
    Get your Workspace Id and token from [app.caesr.ai](https://app.caesr.ai)
    </Tip>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Authentication errors">
    ...
    - Check workspace ID and token from app.caesr.ai
