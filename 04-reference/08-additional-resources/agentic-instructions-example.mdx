...
Create a markdown report at: `{folder_name}/{index + 1}_{test_case.test_case_id}.md`
...
**Report Structure:**
    ...
    **Evidence:** ![Screenshot](./{index + 1}_{test_case.test_case_id}_images/[descriptive_filename].png)
...
- If the test is blocked, try to unblock it:
  ...
  * Document the unblock attempt:
    ### Unblock attempt X: [Unblock action Description]
    **Evidence:** ![Screenshot](./{index + 1}_{test_case.test_case_id}_images/[descriptive_filename].png)
