...
<a id="askui.agent_base"></a>

# askui.agent\_base

<a id="askui.agent_base.AgentBase"></a>

## askui.agent\_base.AgentBase

```python
class AgentBase(ABC)
```

<a id="askui.agent_base.AgentBase.act"></a>
...
<a id="askui.agent_base.AgentBase.get"></a>
...
<a id="askui.agent_base.AgentBase.locate"></a>
...
<a id="askui.agent_base.AgentBase.locate_all"></a>
...
<a id="askui.agent_base.AgentBase.locate_all_elements"></a>
...
<a id="askui.agent_base.AgentBase.annotate"></a>
...
<a id="askui.agent_base.AgentBase.wait"></a>
