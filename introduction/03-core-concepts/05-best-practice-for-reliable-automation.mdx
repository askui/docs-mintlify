...
### Solutions
<AccordionGroup>
  <Accordion title="Re-Teach the OCR Model">
...
<Columns cols={2}>
  ...
  <Card>
    ...
    <div style={{ marginBottom: '12px' }}>
      ![Icon Text Merging Expected Behaviour2.png](./images/images/IconTextMergingExpectedBehaviour2.png)
    </div>
...
<AccordionGroup>
  ...
  <Accordion title="Use Default Word-Level Detection">
