...
**Example:** Say you want to click \*\*just the charachter “2” - but OCR does not detects them:
...
1.Follow[ tutorial](https://docs.askui.com/introduction/03-core-concepts/01-element-selection/01-element-selection#ai-elements)
...
1. Select the Text as [AI Element](https://docs.askui.com/introduction/03-core-concepts/01-element-selection/01-element-selection#ai-elements)