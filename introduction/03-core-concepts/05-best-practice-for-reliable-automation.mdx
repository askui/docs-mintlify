...
The OCR model sometimes misreads characters, especially in certain fonts or noisy images. This can result in words being misclassified or misspelled, which then causes the automation to fail when it searches for exact matches.
 ...
 <Columns cols={2}>
  ...
  <Card>
    <div style={{ borderBottom: '1px solid #ccc', display: 'inline-block', paddingBottom: '4px', marginBottom: '8px' }}>
      <strong>Expected (Truth)</strong>
    </div>
  ...
  <Card>
    <div style={{ borderBottom: '1px solid #ccc', display: 'inline-block', paddingBottom: '4px', marginBottom: '8px' }}>
      <strong>OCR Output (Prediction)</strong>
    </div>
    <div style={{ marginTop: '8px' }}>
      <code>HaII0</code>
    </div>
...
<Columns cols={2}>
  ...
  <Card title="❌ Actual Issue">
    ...
    🖼️ I\_con and text are detected together:\_
...
🖼️ I_con and text are detected together:\_
...
![image.png](attachment:b6dd41f2-63e1-4fdb-9c50-33571a63c3e0:image.png)
...
![image.png](attachment:38923942-c474-4d0a-89ed-350cc168034b:image.png)
