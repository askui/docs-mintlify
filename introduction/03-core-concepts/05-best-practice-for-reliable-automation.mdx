...
<AccordionGroup>
  <Accordion title="Vision Agent – Character Level Example">
...
<AccordionGroup>
  <Accordion title="Vision Agent – YAML Block Example">
...
<AccordionGroup>
  <Accordion title="Vision Agent – Production Workspace Example">
...
<AccordionGroup>
  <Accordion title="Vision Agent Code Snippet">
...
<AccordionGroup>
  <Accordion title="Vision Agent – TSX Code Example">
    ```tsx
    await aui.click().text("Alice Johnson").exec([{
        "task": "e2e_ocr",
        "architecture": "easy_ocr",
...
<AccordionGroup>
  <Accordion title="Vision Agent – Click & OCR Example">
    ```tsx
    await aui.click().text("Alice Johnson").exec([{
        "task": "e2e_ocr",
        "architecture": "easy_ocr",
...
<AccordionGroup>
  <Accordion title="Vision Agent – Word-Level OCR (Static Workspace ID)">
    ```tsx
    await aui.click().text("Alice Johnson").exec([{
        "task": "e2e_ocr",
        "architecture": "easy_ocr",
...
<AccordionGroup>
  <Accordion title="Vision Agent – Word-Level OCR (Placeholder Workspace ID)">
    ```tsx
    await aui.click().text("Alice Johnson").exec([{
        "task": "e2e_ocr",
        "architecture": "easy_ocr",
