...
<CardGroup cols="2">
  ...
  <Card title="Agent Framework" icon="sparkles" href="/02-api-reference/01-agent-frameworks/02-python/01-installation">
    ...
    The AskUI Agent Framework is a **Python library** that enables you to build and run AI-powered Vision Agents, allowing for flexible and scalable UI automation using computer vision and natural language commands.
  </Card>
</CardGroup>
