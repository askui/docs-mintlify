...
<img alt="Hero Light" classname="block dark:hidden" src="./images/agent-os.png" />
...
<CardGroup cols={2}>
  <Card title="Installation Guide" icon="book" href="/introduction/02-getting-started/02-installation-guide">
    Our website offers a seamless onboarding experience where you can create an account, get access tokens, download the software, and use templates to build your first AI Vision Agent.
  </Card>

  <Card title="Agent Framework. Python." icon="lightbulb" href="/introduction/02-getting-started/02-installation-guide">
    This tutorial walks you through a simple **calculator example** to help you get started.  Before you begin, **make sure you have downloaded and installed the software** to follow along smoothly.
  </Card>
</CardGroup>
