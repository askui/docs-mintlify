...
\
Yes. Given you use our inference, we are compliant to the standards of safety. External models such as Anthropic or other LLM do not fall under our Service Level Agreement (SLA).
