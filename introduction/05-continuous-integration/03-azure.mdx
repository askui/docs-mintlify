...
`- bash: |`
`     curl -o allure-commandline-2.10.0.tgz -OLs  `[`https://repo.maven.apache.org/maven2/io/qameta/allure/allure-commandline/2.10.0/allure-commandline-2.10.0.tgz`](https://repo.maven.apache.org/maven2/io/qameta/allure/allure-commandline/2.10.0/allure-commandline-2.10.0.tgz)
...
*`# Install `*[*`https://github.com/mclay/azure-pipeline-allure-report`*](https://github.com/mclay/azure-pipeline-allure-report)*` first`*
