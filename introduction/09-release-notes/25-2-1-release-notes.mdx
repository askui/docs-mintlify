...
<details>
  <summary><code>AskUI-TestLongPathSupport</code> - Check if the <a href="https://learn.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation?tabs=registry">LongPath</a> </summary>
