...
<CardGroup cols={2}>
  ...
  <Card title="Complex Structures" icon="sitemap" href="/02-how-to-guides/05-build-ai-agents/extract-data-from-ui/complex-structures">
    Extract nested and complex data using Pydantic models
  </Card>
</CardGroup>
