...
description: "Learn about re-teaching vs training and how to improve model performance for your specific needs."
---
...
- **LLMs and LAMs are re-teachable models, like GPT4, Anthropic Claude etc**
