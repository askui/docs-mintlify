...
# Single-step: Developer controls decision-making, AI handles execution
...
- Review **[Core Components](/03-explanation/01-foundations/core-components)** to understand the Vision Agent
