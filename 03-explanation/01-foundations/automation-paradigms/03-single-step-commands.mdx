...
- **Locator-Based Selection**: Use structured [locators](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators) to find elements by text, type, or image
- **Relative Locators**: Find elements based on their spatial relationship to other elements - see [Relative locators](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#askui-locators-relatable)
- **AI Elements**: Capture and reuse specific visual elements for repeated interactions - see [AI Element locators](/04-reference/01-agent-frameworks/02-python/02-vision-agent-api/locators#askui-locators-aielement)
