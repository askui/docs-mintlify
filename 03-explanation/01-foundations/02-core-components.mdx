...
AskUI provides specialized agents for different platforms - learn more about [Multi-Platform Support](/03-explanation/01-foundations/03-multi-platform-support).
