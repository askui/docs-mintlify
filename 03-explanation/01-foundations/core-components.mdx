...
AskUI provides specialized agents for different platforms - learn more about [Agent Types](/03-explanation/01-foundations/agent-types).
...
- Learn about [Automation Paradigms](/03-explanation/01-foundations/automation-paradigms)
