...
{/* NOTE: The image references in this document need to be updated with actual screenshots from the workspace settings interface. */}
...
![](./images/workspace-invitations.png)
