...
<Warning>
  During installation, set **Connection Scope** to **Public (0.0.0.0)**. The default Private (127.0.0.1) only accepts local connections and will prevent the SDK from reaching AgentOS over the network.
</Warning>
