...
- `content` _Union[str, dict, list]_ - The message content, which can be a string, dictionary, or list, e.g. `'click 2x times on text "Edit"'`
- `image` _Optional[PIL.Image.Image | list[PIL.Image.Image]], optional_ - PIL Image or list of PIL Images to include with the message
